...
\author{\small *No authors' information during review process.}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=3.3in]{assets/ontology}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=3.5in]{assets/ontology_guided}
    \caption{Ontology-guided triplet extraction using single-stage prompting}
    \label{fig_ontology_guided}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=3.5in]{assets/graph-qwen3b-adze}
    \caption{Graph extracted from text "Adze" with ontology - Qwen2.5 3B}
    \label{fig_graph_qwen3b_adze}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=3.5in]{assets/graph-r1-adze}
    \caption{Graph extracted from text "Adze" with ontology - DeepSeek R1}
